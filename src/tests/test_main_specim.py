...
config_specim_preprocess = SettingsPreprocess(dtype_datacube = np.float32, 
                            ...
                            mission_name = '2022-08-31_1040_HSI',
...
config_path_template = 'data/config_examples/configuration_specim.ini'
...
custom_config = {'General':
                    {'missiondir': DATA_DIR,
                    'modelexporttype': 'geoid', # Ray trace onto geoid
                    'maxraylength': 120}, # Max distance in meters from spectral imager to seafloor
                ...
                'Orthorectification':
                    ...
                    'resolutionhyperspectralmosaic': 1, # Resolution in m
                ...
                'HDF.raw_nav': {
                    ...
                    'eul_is_degrees' : True},
                'Absolute Paths': {
                    'geoid_path' : 'data/world/geoids/no_kv_HREF2018A_NN2000_EUREF89.tif',
                    #'geoid_path' : 'data/world/geoids/egm08_25.gtx',
                    #'dempath' : 'D:/HyperspectralDataAll/HI/2022-08-31-060000-Remoy-Specim/Input/GIS/DEM_downsampled_deluxe.tif', 
                    ...
                    'pathtide' : 'D:/HyperspectralDataAll/HI/2022-08-31-060000-Remoy-Specim/Input/tidevann_nn2000_NMA.txt'}
